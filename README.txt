...
a persistence unit "ServidorMurilloJordanPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ServidorMurilloJordan\pom.xml":
...
artifact ("ServidorMurilloJordan.war") is already built. You can build
